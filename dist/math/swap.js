 ...
 */
export function getLowerSqrtPriceFromCoinA(amount, liquidity, sqrtPriceX64) {
 ...
 * @returns LowesqrtPriceX64
 */
export function getUpperSqrtPriceFromCoinA(amount, liquidity, sqrtPriceX64) {
    const numerator = liquidity.mul(sqrtPriceX64).shln(64);
 ...
 * @returns LowesqrtPriceX64
 */
export function getLowerSqrtPriceFromCoinB(amount, liquidity, sqrtPriceX64) {
 ...
 * @returns LowesqrtPriceX64
 */
export function getUpperSqrtPriceFromCoinB(amount, liquidity, sqrtPriceX64) {
    // always round down (rounding up a negative number)
